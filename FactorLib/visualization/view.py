...
from bokeh.models.widgets import DataTable, PreText, TableColumn, Select, NumberFormatter
...
ts1.line('date', 'absolute', legend='portfolio', source=source)
